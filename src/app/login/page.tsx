...
const DEMO_CLIENT_EMAIL = "demo.channel@dearmanagement-channel.invalid";
...
export default function ClientLoginPage() {
  ...
  function beginLocation() {
    setStep("gps");
    setGpsSteps([
      { label: "Perangkat", value: navigator.userAgent.includes("Mobile") ? "Mobile · DEAR Management Channel 1.0" : "Desktop · DEAR Management Channel 1.0" },
      { label: "Koordinat", value: "Mencari lokasi…" },
      { label: "Notifikasi ke DEAR Management", value: "Menunggu…" },
    ]);
      ...
      fetch("/api/client-auth/checkin", {
        ...
        .then((data) => {
          setGpsSteps([
            ...
            { label: "Notifikasi ke DEAR Management", value: `Terkirim ${new Date(data.at).toLocaleTimeString("id-ID", { hour: "2-digit", minute: "2-digit" })}` },
          ]);
          setGpsReady(true);
        });
    ...
    <div className="min-h-screen grid place-items-center p-5 sm:p-10">
      <div className="w-full max-w-[400px]">
        <div className="flex flex-col items-center gap-3 mb-6 text-center">
          ...
          <div>
            <div className="text-[11px] tracking-[0.32em] uppercase text-[var(--gold)] font-semibold">DEAR MANAGEMENT</div>
        ...
        <div className="mt-5 flex flex-wrap gap-2.5 justify-center">
          <a
            href="/downloads/dear-channel.apk"
            download
          ...
          <a
            href="https://github.com/emanagementrecruitment-ekhy/ar-client-dear-management/releases/latest/download/DEAR-Management-Channel-Desktop-Setup.exe"
            className="text-[10px] tracking-[0.14em] uppercase text-[var(--gold)] border border-[var(--goldline)] rounded-full px-4 py-2 hover:bg-[rgba(201,162,74,0.1)] transition"
          >
