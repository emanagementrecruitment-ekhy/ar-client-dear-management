...
// the admin session in src/lib/auth.ts, so a DEAR Management staff member's
// admin login and a Mami/Channel's own login can never be confused for one another.
const CLIENT_SESSION_COOKIE = "dearchannel_client_session";
