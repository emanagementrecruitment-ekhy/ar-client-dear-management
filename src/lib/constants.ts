...
// Outlet options for the ledger — TEMPORARY placeholder copied from the
// sibling AR Corp Channel app's own outlet roster. Replace with DEAR
// Management's real outlet/venue list once provided; until then, admins can
// still type a new outlet name directly in the form (see admin/[id]/page.tsx).
